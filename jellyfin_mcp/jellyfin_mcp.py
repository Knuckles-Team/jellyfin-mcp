...
def jellyfin_mcp() -> None:
    ...
    """
    parser = argparse.ArgumentParser(add_help=False, description="Jellyfin MCP Server")
    parser.add_argument(
        "-t",
        "--transport",
...
def usage():
    print(
        f"Jellyfin Mcp ({__version__}): Jellyfin MCP Server\n\n"
        "Usage:\n"
        ...
        "--required-scopes                  [ Comma-separated list of required scopes (e.g., jellyfin.read,jellyfin.write). ]\n"
