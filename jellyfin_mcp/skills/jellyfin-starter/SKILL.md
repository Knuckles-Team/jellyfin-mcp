---
name: jellyfin-starter
description: >-
  Jellyfin API + MCP Server + A2A Server Use when working with Jellyfin via this package's MCP
...
license: MIT
tags: [jellyfin-starter, starter, mcp]
metadata:
  author: Genius
  version: '0.1.0'
---

# Jellyfin Starter Skill

Starter skill for the **Jellyfin** package. Use the `mcp-client` universal skill
