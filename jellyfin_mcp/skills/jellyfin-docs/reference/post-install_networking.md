[Skip to main content](https://jellyfin.org/docs/general/post-install/networking/#__docusaurus_skipToContent_fallback)
...
`ctrl``K`
  ...
  * [Post-Install Setup](https://jellyfin.org/docs/general/post-install/networking/)
    ...
    * [Networking](https://jellyfin.org/docs/general/post-install/networking/)
      ...
      * [Advanced Networking](https://jellyfin.org/docs/general/post-install/networking/)
  ...
  * [Administration](https://jellyfin.org/docs/general/post-install/networking/)
  * [Server Guide](https://jellyfin.org/docs/general/post-install/networking/)
...
[](https://github.com/jellyfin/jellyfin.org/edit/master/docs/general/post-install/networking/index.md)
[Previous Setup Wizard Walkthrough](https://jellyfin.org/docs/general/post-install/setup-wizard)[Next Tailscale](https://jellyfin.org/docs/general/post-install/networking/tailscale)
  * [Port Bindings](https://jellyfin.org/docs/general/post-install/networking/#port-bindings)
  * [Accessing Jellyfin](https://jellyfin.org/docs/general/post-install/networking/#accessing-jellyfin)
    * [Firewall / Port Forwarding](https://jellyfin.org/docs/general/post-install/networking/#firewall--port-forwarding)
    * [External Access](https://jellyfin.org/docs/general/post-install/networking/#external-access)
    * [SSL / https](https://jellyfin.org/docs/general/post-install/networking/#ssl--https)
    * [Base URL](https://jellyfin.org/docs/general/post-install/networking/#base-url)
