[Skip to main content](https://jellyfin.org/docs/general/administration/backup-and-restore/#__docusaurus_skipToContent_fallback)
...
`ctrl``K`
  ...
  * [Post-Install Setup](https://jellyfin.org/docs/general/administration/backup-and-restore/)
  * [Administration](https://jellyfin.org/docs/general/administration/backup-and-restore/)
  ...
  * [Server Guide](https://jellyfin.org/docs/general/administration/backup-and-restore/)
...
## Why Backing Up is Important[​](https://jellyfin.org/docs/general/administration/backup-and-restore/#why-backing-up-is-important "Direct link to Why Backing Up is Important")
...
## Built-in Backup[​](https://jellyfin.org/docs/general/administration/backup-and-restore/#built-in-backup "Direct link to Built-in Backup")
...
### Create a Built-in Backup[​](https://jellyfin.org/docs/general/administration/backup-and-restore/#create-a-built-in-backup "Direct link to Create a Built-in Backup")
...
The Backup system will check for at least 5GB of free space in the backup folder where backups a written to. However this can easily not be enough if you also backup Subtitles and Trickplay so ensure you have enough free space there. The Backup folder is located within your Jellyfin data directory, by default:
...
### Restore from a Built-in Backup[​](https://jellyfin.org/docs/general/administration/backup-and-restore/#restore-from-a-built-in-backup "Direct link to Restore from a Built-in Backup")
...
## Manual Backup[​](https://jellyfin.org/docs/general/administration/backup-and-restore/#manual-backup "Direct link to Manual Backup")
Taking a manual Backup essentially involves you copying all the data jellyfin requires on your own.
### Create a Manual Backup[​](https://jellyfin.org/docs/general/administration/backup-and-restore/#create-a-manual-backup "Direct link to Create a Manual Backup")
...
### Restore from a Manual Backup[​](https://jellyfin.org/docs/general/administration/backup-and-restore/#restore-from-a-manual-backup "Direct link to Restore from a Manual Backup")
...
[](https://github.com/jellyfin/jellyfin.org/edit/master/docs/general/administration/backup-and-restore.md)
[Previous Stereo Downmix](https://jellyfin.org/docs/general/post-install/transcoding/downmix)[Next Configuration](https://jellyfin.org/docs/general/administration/configuration)
  * [Why Backing Up is Important](https://jellyfin.org/docs/general/administration/backup-and-restore/#why-backing-up-is-important)
  * [Built-in Backup](https://jellyfin.org/docs/general/administration/backup-and-restore/#built-in-backup)
    * [Create a Built-in Backup](https://jellyfin.org/docs/general/administration/backup-and-restore/#create-a-built-in-backup)
    * [Restore from a Built-in Backup](https://jellyfin.org/docs/general/administration/backup-and-restore/#restore-from-a-built-in-backup)
  * [Manual Backup](https://jellyfin.org/docs/general/administration/backup-and-restore/#manual-backup)
    * [Create a Manual Backup](https://jellyfin.org/docs/general/administration/backup-and-restore/#create-a-manual-backup)
    * [Restore from a Manual Backup](https://jellyfin.org/docs/general/administration/backup-and-restore/#restore-from-a-manual-backup)
